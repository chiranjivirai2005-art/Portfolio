      ...
      <header className="glass-nav sticky top-0 z-30">
        <nav className="mx-auto flex max-w-7xl flex-col gap-4 px-5 py-4 md:flex-row md:items-center md:justify-between">
          <NavLink to="/" className="flex items-center gap-3 text-xl font-semibold text-white">
            <span className="grid h-10 w-10 place-items-center rounded-lg bg-[#d7b46a] text-sm font-black text-slate-950 shadow-[0_14px_36px_rgba(215,180,106,0.26)]">
              CK
            </span>
            <span className="brand-name">Chiranjivi Kumar</span>
          </NavLink>
          <div className="flex flex-wrap items-center gap-2">
            ...
            {isAdmin ? (
              <button
                className="nav-link rounded-md border border-white/15 bg-white/8 px-3 py-2 text-sm font-semibold text-cyan-50/82 transition hover:border-white/35 hover:text-white"
                onClick={logout}
                type="button"
              >
                Sign out
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `nav-link rounded-md border px-3 py-2 text-sm font-semibold transition ${
                    isActive
                      ? 'nav-link-active border-[#d7b46a]'
                      : 'border-[#d7b46a]/45 bg-[#d7b46a]/12 text-white hover:border-[#d7b46a] hover:bg-[#d7b46a]/20'
                  }`
                }
              >
                Log in
